...
def cadastrar_filmes(generos, filmes, indice_genero):
    generos = ["Ação", "Comédia", "Drama", "Fantasia", "Terror"]
    while True:
        filmes = print(f"Digite título de 3 filmes: ")
        indice_genero = print(f"Digite o índice do genero: ")
    while try:
        return len(generos, filmes, indice_genero)
